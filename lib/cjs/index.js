...
async function connect({
  ...
  if (ignoreAllFlags === true) {
    ...
    flags[indexDisableFeatures] = `${flags[indexDisableFeatures]},AutomationControlled,OptimizationGuideModelDownloading,OptimizationHintsFetching,OptimizationTargetPrediction`;
